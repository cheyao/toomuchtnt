...
public class TNTx5 extends Block {
    public static final MapCodec<TNTx5> CODEC = createCodec(TNTx5::new);

    public MapCodec<TNTx5> getCodec() {
        return CODEC;
    }

    public TNTx5(Settings settings) {
        super(settings);
    }
